...
<div id="PropertyMainDiv" <?php if ($p_list_sidebar == 1) {  echo 'style="width:680px;"';} ?>>
<h1><?php if ($catproperty) { echo $catproperty; } ?></h1>
...
<div id="slider" class="flexslider">
	<ul class="slides">
		...
		<li>
            ...
            ?>
  			<div class="flex-caption"><h1><?php  the_title();?> </h1><?php the_excerpt();?> </div>
		</li>
		<?php 
        endwhile;	
        wp_reset_query();	
...
<div class="QVProInfo">
    ...
    <div class="meta">
     ...
     <div class="QVProText"><?php the_excerpt();?> </div>
  </div>
